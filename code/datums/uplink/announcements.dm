...
/datum/uplink_item/abstract/announcements/fake_ion_storm
	...
	desc = "Interferes with the city's ion sensors. Triggers immediately upon investment."
	item_cost = 10
...
/datum/uplink_item/abstract/announcements/fake_radiation
	...
	desc = "Interferes with the city's radiation sensors. Triggers immediately upon investment."
	item_cost = 15
